	...
	<div class="panel-group">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
					...
					<!-- 
					 ...
					 <tr>
					 	...
					 	<td>
								...
								<form action="memberdelete.action" method="post" class="deleteForm">
									<button type="submit" class="btn btn-default btn-xs btnDelete" id="mid" name="mid"
				...
				<button type="button" class="btn btn-defalt btn-sm" role="badge">
