...
, SSN               VARCHAR2(20)            -- 주민번호 → 암호화 기능 적용
, BIRTHDAY          DATE                    -- 생년월일
...
INSERT INTO EMPLOYEE(EMPLOYEEID, NAME, SSN, BIRTHDAY, LUNAR, TELEPHONE, DEPARTMENTID, POSITIONID, REGIONID, BASICPAY, EXTRAPAY) VALUES(EMPLOYEESEQ.NEXTVAL, '김상기', CRYPTPACK.ENCRYPT('9610041234567', '9610041234567'), TO_DATE('1996-10-04', 'YYYY-MM-DD'), 0,  '010-5693-4223', 1, 2, 1, 2500000, 1500000)
;
    -- 이백오십만, 백오십만
...
SELECT EMPLOYEEID, NAME, SSN, BIRTHDAY, LUNAR, LUNARNAME, TELEPHONE, DEPARTMENTID
...
-- ○ 부서 데이터 조회 쿼리문 구성(직위 데이터 삭제 가능여부 확인 포함)
...
-- SSN2 → SUBSTR(복호화(대상, '9610041234567'), 7, 7) → '1234567'
--          암호화( SUBSTR(복호화(대상, '9610041234567'), 7, 7), SUBSTR(복호화(대상, '9610041234567'), 7, 7) )
--          암호화( '1234567', '1234567' )
UPDATE EMPLOYEE
...
VALUES( EMPLOYEESEQ.NEXTVAL, '이연주', '950816', CRYPTPACK.ENCRYPT('2234567', '2234567')
      , TO_DATE('1996-08-16', 'YYYY-MM-DD' ), 0, '010-4423-0463', 1, 1, 1
      , 1500000, 1500000); -- 백오십만, 백오십만
      
--> 한 줄 구성
INSERT INTO EMPLOYEE( EMPLOYEEID, NAME, SSN1, SSN2, BIRTHDAY, LUNAR, TELEPHONE, DEPARTMENTID, POSITIONID, REGIONID, BASICPAY, EXTRAPAY) VALUES( EMPLOYEESEQ.NEXTVAL, '이연주', '950816', CRYPTPACK.ENCRYPT('2234567', '2234567'), TO_DATE('1996-08-16', 'YYYY-MM-DD' ), 0, '010-4423-0463', 1, 1, 1, 1500000, 1500000)
;
-- 백오십만, 백오십만
--==>> 1 행 이(가) 삽입되었습니다.
...
/*
1	김상기	1996-10-04	0	010-5693-4223	1	2	1	2500000	1500000	961004	=o???	0
2	이연주	1996-08-16	0	010-4423-0463	1	1	1	1500000	1500000	950816	Y{?7?	1
*/
...
2	이연주	950816	1996-08-16	0	양력	010-4423-0463	1	개발부	1	사원	1	서울	1500000	1500000	3000000	1
*/
...
UPDATE EMPLOYEE
SET NAME='이름'
  , BIRTHDAY=TO_DATE('1222-33-22', 'YYYY-MM-DD')
  , LUNAR=0
  , TELEPHONE='010-2222-4444'
  , DEPARTMENTID=1
  , POSITIONID-=2
  , REGIONID=1
  , BASICPAY=2500000
...
---> 한 줄 구성
UPDATE EMPLOYEE SET NAME='이름', BIRTHDAY=TO_DATE('1222-10-22', 'YYYY-MM-DD'), LUNAR=0, TELEPHONE='010-2222-4444', DEPARTMENTID=1, POSITIONID=2, REGIONID=1, BASICPAY=2500000, EXTRAPAY=1500000, SSN1='961004', SSN2=CRYPTPACK.ENCRYPT('1234567', '1234567'), GRADE=0 WHERE EMPLOYEEID=2
;
--==>> 1 행 이(가) 업데이트되었습니다.
...
SELECT DEPARTMENTNAME FROM DEPARTMENTVIEW ORDER BY DEPARTMENTID
...
UPDATE DEPARTMENT SET DEPARTMENTNAME='자원부' WHERE DEPARTMENTID=3
;
--==>> 1 행 이(가) 업데이트되었습니다.
...
-- ○ 직원 검색 쿼리문 구성(이름으로 직원 검색)
SELECT EMPLOYEEID, NAME, SSN1, TO_CHAR(BIRTHDAY, 'YYYY-MM-DD') AS BIRTHDAY, LUNAR, TELEPHONE, DEPARTMENTID, POSITIONID, REGIONID, BASICPAY, EXTRAPAY FROM EMPLOYEE WHERE NAME='이연주'
;
--==>> 2	이연주	950816	1996-08-16	0	010-4423-0463	1	1	1	1500000	1500000
